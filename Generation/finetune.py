...
from modeling_csgrec import CSG4Rec
# import wandb
from utils import *
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='CSG4Rec')
    ...
    sender = EmailSender(
        sender_email="",
        auth_code=""  # your email auth code
    )
    sender.send_email(
        to_email="",
        subject="",
        content="",
        # attachments=["./result.json"]  # optional
    )
    sys.exit(0)
