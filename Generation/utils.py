...
def parse_dataset_args(parser):
    ...
    parser.add_argument("--user_index_file", type=str, default=".Instruments.index.epoch10000.alpha1e-1-beta1e-4.json", help="the user indices file")
    parser.add_argument("--sep_token", type=str, nargs="+", default=[])
