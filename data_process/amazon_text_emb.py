...
def parse_args():
    ...
    parser.add_argument('--plm_name', type=str, default='llama2_7b')
    # parser.add_argument('--plm_checkpoint', type=str,
    #                     default='/home/liuwei/.cache/huggingface/hub/models--bert-base-uncased/snapshots/86b5e0934494bd15c9632b12f734a8a67f723594')
    parser.add_argument('--plm_checkpoint', type=str,
                        default='/home/liuwei/.cache/huggingface/hub/models--meta-llama--Llama-2-7b-hf/snapshots/01c7f73d771dfac7d292323805ebc428287df4f9')
...
if __name__ == '__main__':
    ...
    plm_tokenizer, plm_model = load_plm(args.plm_checkpoint, device=args.device)
