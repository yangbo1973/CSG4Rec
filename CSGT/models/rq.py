...
class ResidualVectorQuantizer(nn.Module):
    ...
    def __init__(self, n_e_list, e_dim, sk_epsilons, beta = 1,
                 kmeans_init = False, kmeans_iters = 100, sk_iters=100,use_constrain_loss = False):
        super().__init__()
        ...
        self.use_constrain_loss = use_constrain_loss
        ...
        self.vq_layers = nn.ModuleList([VectorQuantizer(n_e, e_dim, beta=beta,
                                                        ...
                                                        sk_iters=sk_iters,use_constrain_loss = self.use_constrain_loss)
